...
```
tar xvf geth-linux-amd64-1.14.4-5550d839.tar.gz
cd geth-linux-amd64-1.14.4-5550d839
...
```
cd ~
rm geth-linux-amd64-1.14.4-5550d839.tar.gz
rm -r geth-linux-amd64-1.14.4-5550d839
```
