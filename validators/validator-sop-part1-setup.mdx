...
```
cd ~
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v6.0.2/beacon-chain-v6.0.2-linux-amd64
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v6.0.2/validator-v6.0.2-linux-amd64
```
...
```
mv beacon-chain-v6.0.2-linux-amd64 beacon-chain
mv validator-v6.0.2-linux-amd64 validator
```
