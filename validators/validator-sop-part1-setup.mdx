...
```
tar xvf geth-linux-amd64-1.16.2-dd1ebac1.tar.gz
cd geth-linux-amd64-1.16.2-dd1ebac1
...
```
cd ~
rm geth-linux-amd64-1.16.2-dd1ebac1.tar.gz
rm -r geth-linux-amd64-1.16.2-dd1ebac1
```
