...
```
cd ~
curl -LO https://github.com/paradigmxyz/reth/releases/download/v1.9.0/reth-v1.9.0-x86_64-unknown-linux-gnu.tar.gz
```
...
```
tar xvf reth-v1.9.0-x86_64-unknown-linux-gnu.tar.gz
...
```
cd ~
rm reth-v1.9.0-x86_64-unknown-linux-gnu.tar.gz
```
...
```
cd ~
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v6.1.4/beacon-chain-v6.1.4-linux-amd64
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v6.1.4/validator-v6.1.4-linux-amd64
```
...
```
mv beacon-chain-v6.1.4-linux-amd64 beacon-chain
mv validator-v6.1.4-linux-amd64 validator
```
