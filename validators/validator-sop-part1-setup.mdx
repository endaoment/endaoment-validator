...
First, you'll need hardware to run the validator software on. [Requirements can be found here](https://www.quicknode.com/guides/infrastructure/node-setup/ethereum-full-node-vs-archive-node/), suggested hardware are as follows:
...
Note: If you plan to set up your validator and take advantage of restaking via [EigenLayer](https://www.eigenlayer.xyz/learn), you will likely want to check [this portion of the guide](/validators/validator-sop-part2-upkeep#appendix-h-eigenlayer-native-restaking) as you can avoid exiting and re-entering by setting up the wihdrawal address correctly during this step.
...
```
tar xvf geth-linux-amd64-1.14.12-293a300d.tar.gz
cd geth-linux-amd64-1.14.12-293a300d
...
```
cd ~
rm geth-linux-amd64-1.14.12-293a300d.tar.gz
rm -r geth-linux-amd64-1.14.12-293a300d
```
...
```
cd ~
curl -LO https://github.com/prysmaticlabs/prysm/releases/download/v5.2.0/beacon-chain-v5.2.0-linux-amd64
curl -LO https://github.com/prysmaticlabs/prysm/releases/download/v5.2.0/validator-v5.2.0-linux-amd64
```
...
```
mv beacon-chain-v5.2.0-linux-amd64 beacon-chain
mv validator-v5.2.0-linux-amd64 validator
```
...
While not essential as you can always regenerate them using your mnemonic, it's good practive to back up the `validator_keys` directory (typically `$HOME/staking-deposit-cli/validator_keys`) on a USB for [emergencies](./validator-sop-part3-emergency.mdx).
...
Note: If you plan to set up your validator and take advantage of restaking via [EigenLayer](https://www.eigenlayer.xyz/learn), you will likely want to check [this portion of the guide](/validators/validator-sop-part2-upkeep#appendix-h-eigenlayer-native-restaking) beofre completing this step.
