...
```
cd ~
curl -LO https://github.com/paradigmxyz/reth/releases/download/v1.9.2/reth-v1.9.2-x86_64-unknown-linux-gnu.tar.gz
```
...
```
tar xvf reth-v1.9.2-x86_64-unknown-linux-gnu.tar.gz
...
```
cd ~
rm reth-v1.9.2-x86_64-unknown-linux-gnu.tar.gz
```
