...
```
cd ~
curl -LO https://github.com/prysmaticlabs/prysm/releases/download/v6.0.0/beacon-chain-v6.0.0-linux-amd64
curl -LO https://github.com/prysmaticlabs/prysm/releases/download/v6.0.0/validator-v6.0.0-linux-amd64
```
...
```
mv beacon-chain-v6.0.0-linux-amd64 beacon-chain
mv validator-v6.0.0-linux-amd64 validator
```
