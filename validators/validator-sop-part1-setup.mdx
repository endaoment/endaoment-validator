...
```
cd ~
curl -LO https://github.com/prysmaticlabs/prysm/releases/download/v5.1.1/beacon-chain-v5.1.1-linux-amd64
curl -LO https://github.com/prysmaticlabs/prysm/releases/download/v5.1.1/validator-v5.1.1-linux-amd64
```
...
```
mv beacon-chain-v5.1.1-linux-amd64 beacon-chain
mv validator-v5.1.1-linux-amd64 validator
```
