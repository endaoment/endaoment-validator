...
```
tar xvf geth-linux-amd64-1.16.7-b9f3a3d9.tar.gz
cd geth-linux-amd64-1.16.7-b9f3a3d9
...
```
cd ~
rm geth-linux-amd64-1.16.7-b9f3a3d9.tar.gz
rm -r geth-linux-amd64-1.16.7-b9f3a3d9
```
...
```
cd ~
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v7.1.0/beacon-chain-v7.1.0-linux-amd64
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v7.1.0/validator-v7.1.0-linux-amd64
```
...
```
mv beacon-chain-v7.1.0-linux-amd64 beacon-chain
mv validator-v7.1.0-linux-amd64 validator
```
