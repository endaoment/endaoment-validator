...
```
tar xvf geth-linux-amd64-1.14.13-eb00f169.tar.gz
cd geth-linux-amd64-1.14.13-eb00f169
...
```
cd ~
rm geth-linux-amd64-1.14.13-eb00f169.tar.gz
rm -r geth-linux-amd64-1.14.13-eb00f169
```
