...
```
cd ~
rm geth-linux-amd64-1.13.14-2bd6bd01.tar.gz
rm -r geth-linux-amd64-1.13.14-2bd6bd01
```
...
```
cd ~
curl -LO https://github.com/prysmaticlabs/prysm/releases/download/v5.0.2/beacon-chain-v5.0.2-linux-amd64
curl -LO https://github.com/prysmaticlabs/prysm/releases/download/v5.0.2/validator-v5.0.2-linux-amd64
```
...
```
mv beacon-chain-v5.0.2-linux-amd64 beacon-chain
mv validator-v5.0.2-linux-amd64 validator
```
