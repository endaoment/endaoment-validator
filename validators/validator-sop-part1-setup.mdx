...
```
tar xvf geth-linux-amd64-1.15.8-f8ff24e8.tar.gz
cd geth-linux-amd64-1.15.8-f8ff24e8
...
```
cd ~
rm geth-linux-amd64-1.15.8-f8ff24e8.tar.gz
rm -r geth-linux-amd64-1.15.8-f8ff24e8
```
...
```
mv beacon-chain-v5.3.0-linux-amd64 beacon-chain
mv validator-v5.3.0-linux-amd64 validator
```
