...
```
cd ~
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v7.0.0/beacon-chain-v7.0.0-linux-amd64
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v7.0.0/validator-v7.0.0-linux-amd64
```
...
```
mv beacon-chain-v7.0.0-linux-amd64 beacon-chain
mv validator-v7.0.0-linux-amd64 validator
```
