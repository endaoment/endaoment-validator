...
```
tar xvf geth-linux-amd64-1.15.0-756cca7c.tar.gz
cd geth-linux-amd64-1.15.0-756cca7c
...
```
cd ~
rm geth-linux-amd64-1.15.0-756cca7c.tar.gz
rm -r geth-linux-amd64-1.15.0-756cca7c
```
