...
```
cd ~
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v7.1.1/beacon-chain-v7.1.1-linux-amd64
curl -LO https://github.com/OffchainLabs/prysm/releases/download/v7.1.1/validator-v7.1.1-linux-amd64
```
...
```
mv beacon-chain-v7.1.1-linux-amd64 beacon-chain
mv validator-v7.1.1-linux-amd64 validator
```
