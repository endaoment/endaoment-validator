...
```
cd ~
curl -LO https://github.com/paradigmxyz/reth/releases/download/v2.2.0/reth-v2.2.0-x86_64-unknown-linux-gnu.tar.gz
```
...
```
tar xvf reth-v2.2.0-x86_64-unknown-linux-gnu.tar.gz
...
```
cd ~
rm reth-v2.2.0-x86_64-unknown-linux-gnu.tar.gz
reth --version
```
