...
Note that even if there is no exit queue, this process will still take time. Exiting requires at least \~30 minutes, and then up to \~27 hours to be swept into the withdrawal address.
